...
@Component({
  ...
  styleUrls: ['./pulseira-form.component.css']
})
export class PulseiraFormComponent implements OnInit {
  formGroup: FormGroup;
  materiais: Enum[] = [];
  cores: Enum[] = [];
  pedras: Enum[] = [];
  ...
  constructor(
    ...
    this.formGroup = this.formBuilder.group({
      ...
      imgPulseira: ['', Validators.required],
